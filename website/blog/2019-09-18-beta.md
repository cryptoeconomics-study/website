...
author: Kevin Ho
authorURL: https://twitter.com/kevinjho_
...
Apply for access to our closed beta! Our beta is completely free and will be capped at 100 users who will have access to an invite-only Discord group with course support from mentors. You’ll also be guaranteed an official certificate of completion.  The course requires basic programming experience and familiarity with Javascript. We expect it to take between 30 and 50 hours to complete. Apply [here](https://forms.gle/SC49hXM6oBCcLFDMA). 

P.S. This course is a labor of love predominantly built by volunteers. It has been no small feat - please consider [donating](https://gitcoin.co/grants/16/cryptoeconomicsstudy-free-open-source-blockchain-2) to our Gitcoin grant ([video tutorial](https://youtu.be/8ArwotlDdYQ)). Let us know in your beta tester application if you are a donor! All funds donated until 9/31 are being [matched](https://gitcoin.co/blog/gitcoins-q3-match-100k-to-oss-projects/) by the Ethereum Foundation, so even small donations of 5-10 DAI make a big impact!
